            ...
            <div>
                ...
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <!-- <p>https://www.linkedin.com/in/bipul-kumar-singh-3b5b601bb/</p> -->
                            <a href="https://www.linkedin.com/in/bipul-kumar-singh-3b5b601bb/">Click Here</a>
                        </div>
                    </div>
                </div>
            </div>
